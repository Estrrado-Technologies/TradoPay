...
public class HomeItemDetailChildMainListAdapter extends RecyclerView.Adapter<HomeItemDetailChildMainListAdapter.HomeItemsListViewHolder> {
    OnItemSelectedlistner onItemSelectedlistner;
    public HomeItemDetailChildMainListAdapter(OnItemSelectedlistner onItemSelectedlistner) {
    ...
    public HomeItemsListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new HomeItemsListViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_home_item_child_main_item,parent,false));
    }
